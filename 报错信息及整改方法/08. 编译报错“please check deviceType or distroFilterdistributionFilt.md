8. 编译报错“please check deviceType or distroFilter/distributionFilter of the module”
...
解决措施
•	可能是打包时工程未满足HAP唯一性校验逻辑，请参考HAP唯一性校验逻辑修改工程配置，满足校验逻辑即可正常打包。
...
8.编译报错“Failed to generate test project build system”
问题现象
